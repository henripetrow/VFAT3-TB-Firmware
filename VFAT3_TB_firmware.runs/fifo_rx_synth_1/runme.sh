...
HD_PWD='/home/a0312687/VFAT3-Testbench/Firmware/vfat3_testing_firmware/vfat3_testing_firmware.runs/fifo_rx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_rx.tcl
