...
HD_PWD='/home/a0312687/Vivado/VFAT3-Testbench_hybrid+I2C/Firmware/vfat3_testing_firmware/vfat3_testing_firmware.runs/ila_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_5.tcl
