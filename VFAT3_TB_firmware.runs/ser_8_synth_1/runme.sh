...
HD_PWD='/home/a0312687/VFAT3-Testbench/Firmware/vfat3_testing_firmware/vfat3_testing_firmware.runs/ser_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ser_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ser_8.tcl
