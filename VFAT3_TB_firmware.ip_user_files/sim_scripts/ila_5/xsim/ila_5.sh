...
xv_path="/home/Xilinx/Vivado/2016.4"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L work -L secureip -L xpm --snapshot ila_5 work.ila_5 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ila_5 -key {Behavioral:sim_1:Functional:ila_5} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/Xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_5.wdb xsim.dir)
