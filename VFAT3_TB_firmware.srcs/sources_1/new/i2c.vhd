...
-- Modified to read 16 bits of data. Henri Petrow
----------------------------------------------------------------------------------
...
architecture Behavioral of i2c is
    ...
    type state_t is (IDLE, START, ADDR, RW, WAIT_0, ACK_0, RD, ACK_1, RST_1, ACK_R1, RST_R1, RD2, ENDING_RD, WR, RST_2, ACK_2, RST_3, ACK_3, RST_4, ACK_4, WR_15_8BITS,WR_7_0BITS, ENDING_WR, STOP,STOP_W, ERROR);
